...
Main thing: For the fitting of the GLMMs, Julia isn’t more useful than R. Slightly less, even, because currently it doesn’t give an advantage in fitting durations with regards to R. *But* that is pretty much bound to change as the Julia eco-system (ugh I hate this word), grows and faster implementations become available. <br>
<br>
